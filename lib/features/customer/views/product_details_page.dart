          ...
          Positioned(
            ...
            child: Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    ref.read(favoriteProvider.notifier).toggleFavorite(widget.product.id);
                  },
                  child: Container(
                    padding: const EdgeInsets.all(10),
                    decoration: BoxDecoration(
                    ...
                    child: Icon(
                      ref.watch(favoriteProvider).contains(widget.product.id)
                          ? Icons.favorite
                ...
                children: [
                  ...
                  Consumer(
                    builder: (context, ref, child) {
                      final restaurantAsync = ref.watch(restaurantProvider(widget.product.restaurantId));
                        ...
                        data: (restaurant) {
                          ...
                          return GestureDetector(
                            onTap: () => Navigator.push(
                              context,
                              MaterialPageRoute(builder: (_) => RestaurantDetailsPage(restaurantId: widget.product.restaurantId)),
                            ),
                            child: Container(
